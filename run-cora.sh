...
do
    ...
    --num_samplers 0 \
    --num_servers 1 \
    --part_config /mnt/shared/development/dgl/juyeong/data/4partition/cora/cora.json \
    --ip_config ip_config.txt \
    "python3 node_classification.py --graph_name cora --ip_config ip_config.txt --num_epochs 2000 --batch_size 200"
done
