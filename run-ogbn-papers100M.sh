...
do
    ...
    --num_samplers 0 \
    --num_servers 1 \
    --part_config /mnt/shared/data/partitioned/parts4/ogb-papers100M/ogb-papers100M.json \
    --ip_config ip_config.txt \
    "python3 node_classification.py --graph_name ogb-papers100M --ip_config ip_config.txt --num_epochs 2000 --batch_size 200"
done
